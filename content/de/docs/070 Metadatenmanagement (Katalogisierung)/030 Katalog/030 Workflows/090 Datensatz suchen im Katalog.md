...
weight: 90
Description: "
    Quellen: [Folio](https://docs.folio.org/docs/metadata/inventory/#searching-for-a-record) <!-- & [GBV](https://info.gebev.de/display/FOLIOGBVEXTERN/Folio:+Datensatz+suchen+im+Katalog) -->
    "
---
